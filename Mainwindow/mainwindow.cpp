    ...
    ui(new Ui::MainWindow)
{
    ...
    connect(ui->checkBox_separate_seats, SIGNAL(clicked(bool)), hallView, SLOT(setSeperateSeats(bool)));
    connect(ui->checkBox_separate_seats, SIGNAL(clicked(bool)), this, SLOT(setComboBox(bool)));
...
void MainWindow::setComboBox(bool seperate)
{
    ...
    ui->comboBox->setDisabled(seperate);
}
...
void MainWindow::updateSelectedSeats(QList<int> seats)
{
    ...
    ui->label_selected_seats->setText(selectedSeats);
}
